...
Here, the pointer _dest_ refers to the first parameter and the pointer _src_ refers to the second one. So strcopy copies a string from one place in memory to another. The description warns us of buffer overruns. In the bugs section we find: 
