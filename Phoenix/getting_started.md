...
Each level in the excercise is a binary for which we need to find an exploit. All of them should be executable and have the setuid bit set. Let us use find to find them.
